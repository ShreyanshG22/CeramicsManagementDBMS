...
public class TilesPolished extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Polished Vitrified Tiles");
        initViews();
        initObjects();
    ...
    private void getDataFromSQLite() {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                listUsers.clear();
                listUsers.addAll(databaseHelper.getTilesPolished());
